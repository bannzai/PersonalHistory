...
### 希望条件
- フルタイムでの稼働ではなくて4時間程度で働かせてくれる場所
- 短時間正社員か、業務委託契約だけどインボイス登録してない人を雇ってくれる場所
- 稼働は週4日希望です
  - もしくは週7日でも良いので、2時間ずつ働かせてくれるような場所
- 地方在住なので、フルリモートになります
- PC支給の場合はM1 Max以上でお願いします
- 子供達が風邪を引いた時に病院に連れていく。といったことが発生する可能性があります。なので、勤務時間がフレキシブルだと嬉しいです
- 給料・報酬について。参考にしてください
...
<details> 
  ...
  <summary>
    <a href="https://stack.inc/"> Stack Inc</a> (2020/4 〜 )
  </summary>
  <div>
  <details>
  <summary>
    <a href="https://stack.inc/pages/appify"> Appify </a> 
  </summary>
  <div>
 ...
 * 平たくいうと自由度の高い会社がいい
 * <details> <summary> backup: 東京にいる時(昔) </summary>
   * 時間や空間で縛られない働き方がベスト
